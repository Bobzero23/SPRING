...
import com.example.Example_SimpleWebApp.model.Address;
import com.example.Example_SimpleWebApp.model.Person;
import com.example.Example_SimpleWebApp.model.Profile;
...
public class ProfileController {
    ...
    public ModelAndView displayMessages(Model model, HttpSession session) {
        ...
        /**getting info from the Person class db to profile object*/
        Profile profile = new Profile();
        profile.setName(person.getName());
        profile.setMobileNumber(person.getMobileNumber());
        profile.setEmail(person.getEmail());
            //also get these if they are available
        ...
        /**telling Spring which page we want to do all of this*/
        ModelAndView modelAndView = new ModelAndView("profile.html");
        modelAndView.addObject("profile", profile);//sending info to UI
        return modelAndView;
    }
