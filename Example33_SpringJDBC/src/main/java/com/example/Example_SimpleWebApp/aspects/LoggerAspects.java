package com.example.Example_SimpleWebApp.aspects;
...
public class LoggerAspects {
    @Around("execution(* com.example.Example_SimpleWebApp..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.example.Example_SimpleWebApp.*.*(..))",throwing = "ex")
