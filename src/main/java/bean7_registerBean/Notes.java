...
* In our code the main point is to register a bean according to random number generated
*
* Note: This time we don't use the component annotation in the field classes */